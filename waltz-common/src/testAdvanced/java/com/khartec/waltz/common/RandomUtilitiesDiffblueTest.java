...
public class RandomUtilitiesDiffblueTest {
  ...
  @Test
  public void randomIntBetweenTest2() {
    // Arrange, Act and Assert
    assertEquals(0, RandomUtilities.randomIntBetween(0, 1));
  }
  ...
  public void randomPickTest4() {
    ...
    // Act and Assert
    assertEquals(1, RandomUtilities.<Object>randomPick(objectList, 64).size());
  }
